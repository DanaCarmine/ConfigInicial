...
Previo 5								   Hernández Rubio Dana Valeria
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model Dedo A (1)
		modelTemp = model = glm::translate(modelTemp, glm::vec3(0.25f, 0.35f, 0.375f));
		...
		//Model Dedo A (2)
		modelTemp = model = glm::translate(modelTemp2, glm::vec3(0.25f, 0.35f, -0.375f));
		model = glm::rotate(model, glm::radians(dedo1), glm::vec3(0.0f, 0.0, 1.0f)); //Dedo
